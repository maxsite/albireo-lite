...
type: blog
announce: Большо́й взрыв — общепринятая космологическая модель, описывающая раннее развитие Вселенной, а именно — начало расширения Вселенной, перед которым Вселенная находилась в сингулярном состоянии.

image-large: [current-path]images/a3.webp
images-dir: [current-path]images

tags: Астрономия, Большой взрыв

next-prev: demo/astronomy/a2, demo/astronomy/a4
