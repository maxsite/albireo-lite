...
type: blog
announce: Мле́чный Путь (также наша Галактика или просто Галактика с прописной буквы) — галактика, в которой находятся Земля, Солнечная система и все отдельные звёзды, видимые невооружённым глазом. Относится к спиральным галактикам с перемычкой.

image-large: [current-path]images/a4.webp
images-dir: [current-path]images

tags: Астрономия, Млечный Путь

next-prev: demo/astronomy/a3, demo/astronomy/a5
