...
title: Звёздная эволюция
date: 04-10-2019
category: astronomy
head-meta[robots]: noindex
type: blog
announce: Эволюция звезды в астрономии — последовательность изменений, которым звезда подвергается в течение её жизни, то есть на протяжении миллионов или миллиардов лет, пока она излучает свет и тепло. В течение таких колоссальных промежутков времени изменения оказываются весьма значительными.

image-large: [current-path]images/a5.webp
images-dir: [current-path]images

tags: Астрономия, Звёздная эволюция

next-prev: demo/astronomy/a4, demo/astronomy/a6
