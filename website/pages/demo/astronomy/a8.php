...
<ul>
<li>75 мм: можно различить Полярную шапку, крупную тёмную область Большой Сирт и темный пояс «морей» в южном полушарии.</li>
<li>100 мм: станут заметны облачные образования на терминаторе и горах, неоднородности в светлых областях, многочисленные детали в морях.</li>
<li>150—200 мм: количество деталей заметно возрастёт, причём часть деталей, казавшихся в меньшие инструменты непрерывными, распадутся на множество более мелких. Для того, чтобы легче было различить тёмные детали поверхности, обычно применяется жёлто-оранжевый фильтр, а если цель наблюдений — полярная шапка и облачные образования, то голубой или зелёный.</li>
</ul>
