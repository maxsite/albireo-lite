...
type: blog
announce: Нейтро́нная звезда́ — космическое тело, являющееся одним из возможных результатов эволюции звёзд, состоящее, в основном, из нейтронной сердцевины, покрытой сравнительно тонкой (около 1 км) корой вещества в виде тяжёлых атомных ядер и электронов.

image-large: [current-path]images/a7.webp
images-dir: [current-path]images

tags: Астрономия, Нейтронная звезда

next-prev: demo/astronomy/a6, demo/astronomy/a8
...
Массы нейтронных звёзд сравнимы с массой Солнца, но типичный радиус нейтронной звезды составляет лишь 10—20 километров. Поэтому средняя плотность вещества такого объекта в несколько раз превышает плотность атомного ядра (которая для тяжёлых ядер составляет в среднем 2,8*10<sup>17</sup> кг/м³). Дальнейшему гравитационному сжатию нейтронной звезды препятствует давление ядерного вещества, возникающее за счёт взаимодействия нейтронов.
...
При дальнейшем сжатии внешних слоёв звезды, где ещё продолжаются термоядерные реакции синтеза, по мере выгорания лёгких ядер, сжатие ядра звезды увеличивается и масса ядра звезды начинает превышать предел Чандрасекара. Давление вырожденного электронного газа становится недостаточным для поддержания гидростатического равновесия, и ядро начинает быстро уплотняться, в результате чего его температура поднимается выше 5*10<sup>9</sup> K. При таких температурах происходит фотодиссоциация ядер железа на альфа-частицы под действием жёсткого гамма-излучения. При последующем увеличении температуры происходит слияние электронов и протонов в нейтроны в процессе электронного захвата. В соответствии с законом сохранения лептонного заряда при этом образуется мощный поток электронных антинейтрино.

Когда плотность звезды достигает ядерной плотности 4*10<sup>17</sup> кг/м<sup>3</sup>, давление вырожденного нейтронного Ферми-газа останавливает сжатие. Падение внешней оболочки звезды на нейтронное ядро останавливается, и она отбрасывается от ядра звезды потоком нейтрино, так как при очень высоких температурах в схлопывающейся оболочке вещество оболочки становится непрозрачным для нейтрино, при этом звезда превращается в сверхновую. После рассеивания внешней оболочки от звезды остаётся звёздный остаток — нейтронная звезда.

Если масса этого остатка превышает 3M, то коллапс звезды продолжается, и возникает чёрная дыра.

По мере того, как ядро массивной звезды сжимается во время взрыва сверхновой II типа, сверхновой Ib типа или Ic типа и коллапсирует в нейтронную звезду, она сохраняет бо́льшую часть своего исходного углового момента. Но, поскольку остаток звезды имеет лишь ничтожную долю радиуса родительской звезды, момент инерции остатка резко уменьшается, и в соответствии с законом сохранения момента импульса нейтронная звезда приобретает очень высокую скорость осевого вращения, которая постепенно уменьшается в течение очень длительного времени. Известны нейтронные звезды с периодами вращения от 1,4 мс до 30 мс.

Большой плотностью нейтронной звезды при малых размерах обусловлено её очень высокое ускорение свободного падения на поверхности с типичными значениями, лежащими в диапазоне от 10<sup>12</sup> до 10<sup>13</sup> м/с<sup>2</sup>, что более чем в 10<sup>11</sup> раз больше, чем на поверхности Земли. При таком высоком тяготении нейтронные звезды имеют скорость убегания в диапазоне от 100 000 км/с до 150 000 км/с, то есть от трети до половины скорости света. Гравитация нейтронной звезды ускоряет падающее на неё вещество до огромных скоростей. Сила его удара, вероятно, достаточна для разрушения атомов падающего вещества и может превратить это вещество в нейтроны. 
