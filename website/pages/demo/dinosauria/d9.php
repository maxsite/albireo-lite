...
category: dinosauria
image-large: [current-path]images/d9.webp
images-dir: [current-path]images
date: 11-04-2019
head-meta[robots]: noindex
type: blog
announce: Плезиозавры (лат. Plesiosauria, др.-греч. πλησίος — близкий, схожий, σαῦρος — ящер) — отряд ископаемых пресмыкающихся, живших с триасового по меловой периоды (около 199,6 — 65,5 млн лет назад). Расцвет пришёлся на юру — ранний мел. Некоторые представители отряда достигали размера до 15—20 м.
...
<i>Плезиозавры (лат. Plesiosauria, др.-греч. πλησίος — близкий, схожий, σαῦρος — ящер) — отряд ископаемых пресмыкающихся, живших с триасового по меловой периоды (около 199,6 — 65,5 млн лет назад). Расцвет пришёлся на юру — ранний мел. Некоторые представители отряда достигали размера до 15—20 м.</i>
...
В 1821 году Уильям Конибер и Генри Томас де ла Беш нашли некоторые отличия у исследуемых ими видов животных от ихтиозавра. Они назвали новую форму плезиозавром.
...
Плезиозавр появляется в 22 эпизоде 3 сезона сериала X-files — «Quagmire». Плезиозавры также появлялись в видеоиграх «Dino Crisis 2» и «Турок: эволюция».

Широко известная Несси, предположительно обитающая в шотландском озере Лох-Несс, по мнению некоторых исследователей, может быть последним представителем плезиозавров (причём фальсификаторы изображали её в соответствии со старыми представлениями о плезиозаврах как о существах с подвижной шеей, способной подниматься высоко над водой — см. например знаменитое фото из газеты Daily Mail за 1934 год; в настоящее время установлено, что шея этих существ была практически неподвижной). Плезиозавры угадываются в описании и некоторых других озёрных монстров. Все эти озёра расположены в высоких широтах Северного полушария и имеют карстовые разломы на дне.
