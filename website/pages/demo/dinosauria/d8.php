...
category: dinosauria
image-large: [current-path]images/d8.webp
images-dir: [current-path]images
date: 30-08-2019
head-meta[robots]: noindex
type: blog
announce: Ихтиоза́вры (лат. Ichthyosauria, от греч. ἰχθύς — рыба и σαῦρος — ящер, буквально: рыбоящеры) — отряд вымерших крупных морских пресмыкающихся из клады ихтиоптеригий, имевших форму, конвергентную рыбам и дельфинам.
...
Анализ ископаемых остатков рода Stenopterygius, найденного в Германии в шахтах Хольцмадена, датированного возрастом 180 млн лет назад и сохранившего небольшие фрагменты мягких тканей показал, что внутренние слои кожи переходили в изолирующий жировой слой как у теплокровных животных.
