...
category: dinosauria
image-large: [current-path]images/d3.webp
images-dir: [current-path]images
date: 15-08-2020
head-meta[robots]: noindex
type: blog
announce: Спиноза́вр (лат. Spinosaurus, буквально — шипастый ящер) — представитель семейства спинозаврид (Spinosauridae), обитавший на территории современной Северной Африки в меловом периоде (112—93,5 млн лет назад).
