...
title: templatemo_540_lava_landing_page
description: [title]
...
landing.copyright: https://templatemo.com/tm-540-lava-landing-page

css.head.url[]: https://fonts.googleapis.com/css?family=Poppins:100,200,300,400,500,600,700,800,900&display=swap
css.head.url[]: [current-path]assets/css/font-awesome.css
css.head.url[]: [current-path]assets/css/templatemo-lava.css
css.head.url[]: [current-path]assets/css/owl-carousel.css

js.lazy.url[]: [current-path]assets/js/popper.js
js.lazy.url[]: [current-path]assets/js/owl-carousel.js
js.lazy.url[]: [current-path]assets/js/scrollreveal.min.js
js.lazy.url[]: [current-path]assets/js/waypoints.min.js
js.lazy.url[]: [current-path]assets/js/jquery.counterup.min.js
js.lazy.url[]: [current-path]assets/js/imgfix.min.js
            ...
            <div class="row">
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <h2>01</h2>
                            <img src="<?= getPageData('current-path') ?>assets/images/features-icon-1.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <h2>02</h2>
                            <img src="<?= getPageData('current-path') ?>assets/images/features-icon-2.png" alt="">
                ...
                <div class="col-lg-4 col-md-6 col-sm-12 col-xs-12"
                    ...
                    <div class="features-item">
                        <div class="features-icon">
                            <h2>03</h2>
                            <img src="<?= getPageData('current-path') ?>assets/images/features-icon-3.png" alt="">
                            <h4>Email Design</h4>
                            <p>Curabitur pulvinar vel odio sed sagittis. Nam maximus ex diam, nec consectetur diam.</p>
                            <a href="#testimonials" class="main-button">
                                More Detail
        ...
        <div class="container">
            <div class="row">
                <div class="left-image col-lg-5 col-md-12 col-sm-12 mobile-bottom-fix-big"
                    data-scroll-reveal="enter left move 30px over 0.6s after 0.4s">
                    <img src="<?= getPageData('current-path') ?>assets/images/left-image.png" class="rounded img-fluid d-block mx-auto" alt="App">
                </div>
                <div class="right-text offset-lg-1 col-lg-6 col-md-12 col-sm-12 mobile-bottom-fix">
                    <ul>
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.4s">
                            <img src="<?= getPageData('current-path') ?>assets/images/about-icon-01.png" alt="">
                            <div class="text">
                        ...
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.5s">
                            <img src="<?= getPageData('current-path') ?>assets/images/about-icon-02.png" alt="">
                            <div class="text">
                        ...
                        <li data-scroll-reveal="enter right move 30px over 0.6s after 0.6s">
                            <img src="<?= getPageData('current-path') ?>assets/images/about-icon-03.png" alt="">
                            <div class="text">
                ...
                <div class="col-lg-10 col-md-12 col-sm-12 mobile-bottom-fix-big"
                    ...
                    <div class="owl-carousel owl-theme">
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="<?= getPageData('current-path') ?>assets/images/testimonial-author-1.png" alt="Author One"></i>
                            </div>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="<?= getPageData('current-path') ?>assets/images/testimonial-author-1.png" alt="Second Author"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="<?= getPageData('current-path') ?>assets/images/testimonial-author-1.png" alt="Author Third"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
                        ...
                        <div class="item service-item">
                            <div class="author">
                                <i><img src="<?= getPageData('current-path') ?>assets/images/testimonial-author-1.png" alt="Fourth Author"></i>
                            </div>
                            <div class="testimonial-content">
                                <ul class="stars">
                                    <li><i class="fa fa-star"></i></li>
            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="sub-footer">
                        ...
                        | Designed by <a rel="nofollow" href="https://templatemo.com">TemplateMo</a> | Powered by <a href="https://maxsite.org/albireo" target="_blank">Albireo CMS</a></p>
                    </div>
                </div>
            </div>
        </div>
