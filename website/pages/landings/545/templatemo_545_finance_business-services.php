...
title: templatemo_545_finance_business (services)
description: [title]
        ...
        <div class="row" id="tabs">
          ...
          <div class="col-md-8">
            <section class='tabs-content'>
              <article id='tabs-1'>
                <img src="<?= getPageData('current-path') ?>assets/images/single_service_01.jpg" alt="">
              ...
              <article id='tabs-2'>
                <img src="<?= getPageData('current-path') ?>assets/images/single_service_02.jpg" alt="">
              ...
              <article id='tabs-3'>
                <img src="<?= getPageData('current-path') ?>assets/images/single_service_03.jpg" alt="">
              ...
              <article id='tabs-4'>
                <img src="<?= getPageData('current-path') ?>assets/images/single_service_04.jpg" alt="">
          ...
          <div class="col-md-12">
            <div class="owl-partners owl-carousel">
              <div class="partner-item">
                <img src="<?= getPageData('current-path') ?>assets/images/client-01.png" alt="">
              </div>
            </div>
          </div>
        </div>
