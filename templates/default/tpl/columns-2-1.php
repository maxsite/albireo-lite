...
# echo tpl(data: $files, tpl: TPL_DIR . 'columns-1.php', add: ['columnClass' => 'w48', 'header' => 'Заголовок', 'description' => 'Описание']);
        ...
        <div class="{{ $columnClass }} w100-tablet mar30-b -bor-gray100 -bor-solid -bor1 -rounded3">
            <div class="b-flex flex-column h100">
                ...
                <div class="w100 flex-grow2 pad10-t h200px-min mar10-b">
                    h1(t130) <a class="color-inherit" href="{{ $page_url }}">{* $title *}</a>
                    
                    {@isset $announce}
                        <div class="t90 animation-fade mar10-b">{{ $announce }}</div>
                    {@endisset}
                    
                    __(t-right) <a class="t90 icon-arrow-right" href="{{ $page_url }}">{@lang Read}</a>
                </div>
