...
/*
echo tpl(data: $files, tpl: TPL_DIR . 'one-columns-3.php', add: ['header' => 'Заголовок', 'description' => 'Описание']);
...
{@loop $DATA}
    <div class="flex flex-wrap-tablet pad20-b mar30-b {@class ['bor-gray300 bor1 bor-dotted-b' => !$loopLast, 'mar20-t' => $loopFirst]}">
        <div class="w300px-min w30 w100-tablet mar20-b-tablet">
        ...
        <div class="w70 pad20-l pad0-tablet w100-tablet">
