...
/*
// аналогично group-1, только без аноносов и дат боковой панели
// используется там, где мало места и много записей

echo tpl(data: $files, tpl: TPL_DIR . 'group-1-1.php', add: ['header' => 'Заголовок', 'description' => 'Описание']);
    ...
    {@if $loopFirst}
        <div class="w55 w100-tablet">
            <div class="">
                ...
                {@isset $announce}
                    __(t100 mar10-tb) {{ $announce }} <a class="icon-arrow-right" href="{{ $page_url }}">{@lang Read}</a>
                {@endisset}
            </div>
        </div>
    {@else}
