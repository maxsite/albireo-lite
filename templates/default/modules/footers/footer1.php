...
// TODO: наверное стоит сделать аналог подвала, где поле bg-primary900 на всю ширину — оно для разных шапок подходит

// меняем цвет фона контейнера меню для разметки с полями
$fields = getVal('layout.fields', false);
$class1 = $fields ? '' : 'bg-primary900';
$class2 = $fields ? 'b-shadow-field' : '';

?>
<!-- nosimple -->
<div class="layout-center-wrap t-primary100 hide-print t90 <?= $class1 ?>">
    <div class="layout-wrap flex flex-wrap bg-primary850 pad30-t pad30-rl <?= $class2 ?>">
        <div class="flex-grow3 w60-max w100-max-tablet w100-tablet pad30-b pad30-r links-no-color hover-no-color">
            ...
            <div class="mar20-t t80 t-primary300">
