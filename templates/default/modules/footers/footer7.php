...
?>
<!-- nosimple -->
<div class="layout-center-wrap t-primary600 mar30-t">
    <div class="layout-wrap pad30-tb bor1 bor-solid-t bor-primary400 t-center">
        <div class="t120">
            <a href="<?= SITE_URL ?>" class="t-bold"><?= $title ?></a>
        </div>
